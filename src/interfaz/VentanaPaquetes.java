...
// =====================================================================
   ...
   private void cargarDatosIniciales() {
    ...
    private void configurarRecepcion() {
        ...
        lstPaquetesRecepcion.addListSelectionListener(new javax.swing.event.ListSelectionListener() {
            public void valueChanged(javax.swing.event.ListSelectionEvent evt) {
                if (!evt.getValueIsAdjusting()) {
                    btnConfirmarRecepcion.setEnabled(
                        lstPaquetesRecepcion.getSelectedIndex() >= 0
                    );
                }
            }
        });
